...
import ems.model.Ref_department;
 ...
 *
 */
public class Ref_departmentController extends BaseController {
	public Ref_departmentController() {
		 setClazz(Ref_department.class);
		}
